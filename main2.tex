...
% 	\centering
%   	\subfloat{
%     \includegraphics[width=0.23\textwidth]{fig/png1_a.png}

%   }
%  	\subfloat[]{
%   	 \includegraphics[width=0.23\textwidth]{fig/png1_b.png}
%   }
% \end{figure}
...
% 	\centering
% 	\includegraphics[width=6cm]{fig/png1_a.png}
% 	\caption{World Map}
% 	\end{minipage}
% 	\begin{minipage}[t]{0.48\textwidth}
% 	\centering
% 	\includegraphics[width=6cm]{fig/png1_b.png}
...
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[width=\linewidth]{fig/png1.png}
%     \caption{Taxi pick-up (a) and drop-off locations (b) distribution.}
%     \label{fig:my_png_1}
% \end{figure}
